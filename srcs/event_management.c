...
/*   Updated: 2022/05/17 14:42:24 by blevrel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "so_long.h"
...
int	allow_move(t_all *struc, int key)
{
	...
	{
		if (struc->map[struc->player.y][struc->player.x] == '0'
			|| struc->map[struc->player.y][struc->player.x] == 'P'
			|| struc->map[struc->player.y][struc->player.x] == 'C')
		{
			if (struc->map[struc->player.y][struc->player.x] == 'C')
